        ...
        <div class="container d-flex justify-content-center align-items-center mt-3 text-dark text-center">
            <div class="row d-flex justify-content-between align-items-center gap-3">
                ...
                while($Result = mysqli_fetch_array($Fire_Query)){
                    ...
                    $_SESSION['Laptop_Stand_Title']=$Result['Laptop Stand Title'];
    
                    $_SESSION['Id']=$Result['Id'];
    
                    $_SESSION["Laptop_Stand_Price"]=$Result['Laptop Stand Price'];
    
                    $_SESSION['Laptop_Stand_Quantity']=$Result['Laptop Stand Quantity'];
                    ?>

                    <!-- Card -->
                    <div class="card col-12 col-sm-3 col-md-3 d-flex justify-content-center align-items-center bg-light">
                        <img src="../Seller/Dashboard/Add Products/<?php echo $Result['Picture 1']; ?>" class="card-img-top img-fluid" alt="Laptop Stand Pic">
                        <div class="card-body">
                            <p class="card-title"><?php echo $Result['Laptop Stand Title']; ?></p>
                            <p class="card-text"><?php echo $Result['Laptop Stand Description']; ?></p>
                            <a href="../Product Pages/Laptop stands/Laptop Stands.php?id=<?php echo $Result['Id']; ?>" class="btn btn-success w-100">Shop</a>
                        </div>
                    </div>
