        ...
        <div class="container d-flex justify-content-center align-items-center mt-3 text-dark text-center">
            <div class="row d-flex justify-content-between align-items-center gap-3">
                ...
                while ($Result = mysqli_fetch_array($Fire_Query)) {
                    ...
                    $_SESSION['Computer_Picture'] = $Result['Picture 1'];


                ?>
                    <!-- Card -->
                    <div class="card col-12 col-sm-3 col-md-3 d-flex justify-content-center align-items-center bg-light">
                        <img src="../Seller/Dashboard/Add Products/<?php echo $_SESSION['Computer_Picture']; ?>" class="card-img-top img-fluid" alt="...">
                        <div class="card-body">
                            <p class="card-title"><?php echo $Result['Computer Title']; ?></p>
                            <p class="bg-success text-white fs-6 p-1 rounded-3 ">Quantity : <?php echo $Result['Computer Quantity']; ?></p>
