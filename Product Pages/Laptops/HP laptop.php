...
<head>
    ...
    <title>Purchase <?php echo $_SESSION['Laptop_Title']; ?> </title>
    ...
    <div class="container-fluid d-flex flex-column justify-content-center align-items-center">
        <div class="row d-flex col-12 justify-content-between p-1 mt-2 align-items-center">
            ...
            <div class="card col-sm-10 col-md-5 col-lg-4 ">
                ...
                $Laptop_Quantity = $Result['Laptop_Quantity'];
            ...
            <div class="text-center col-sm-10 col-md-6 col-lg-6 p-3">
                ...
                if (isset($_POST['Add_To_Cart'])) {
                    ...
                    $Product_Price = $_SESSION['Laptop_Price'];

                    $Total = $_SESSION['Laptop_Price'] * $Buyer_Enter_Quantity;
                ...
                ?>
                    ...
                    $Available_Quantity = $Laptop_Quantity - $Buyer_Enter_Quantity;

                    if ($Available_Quantity < 0) {
                    ?>
                        <script>
                            alert('out of stock <?php echo "Product Quantity is = ". $Laptop_Quantity ?>');
                        </script>
                        <?php
                    } else {
                        ...
                        $update = "UPDATE `laptops table` SET `Laptop_Quantity`='$Available_Quantity' WHERE Id = $getid ";
                ...
                <div class="d-flex justify-content-between p-3">
                    ...
                    <?php
                    $select = "select * from `Laptops table` where Id = $getid";
                    $querrn = mysqli_query($conn, $select);
                    $fetching = mysqli_fetch_array($querrn);
                    $availableqntity = $fetching['Laptop_Quantity'];
                    ?>
