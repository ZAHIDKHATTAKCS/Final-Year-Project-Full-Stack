    ...
    <div class="maindiv d-md-none">
        ...
        <div class="d-block align-items-md-center text-dark text-center h-100 bg-white overflow-scroll p-3">
            ...
            <div class="border border border-dark w-100  rounded-3 shadow-lg mb-3">
                <img src="../../../assets/Icons/Cameras/Canon Camera/Canon 2.jpg" alt="" class="w-100" />
                <!-- Add product Form -->
                <form class="mb-3 text-dark rounded-2 mt-3 p-2" method="post" enctype="multipart/form-data">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="number" name="Camera_Price" class="form-control" placeholder="Enter Price" required />
                    </div>
